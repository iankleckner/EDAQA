...
%   (2) Run the program
%   (3) View the output (3 image files and one data file). See console for
...
filename_out = sprintf('%s--EDAQA.csv', strrep(filename_Q_Sensor, '.csv', ''));
...
filename_figure = 'out-EDAQA-1-raw+filter+QA+valid.png';
...
filename_figure = 'out-EDAQA-2-valid.png';
set(gca, 'LineWidth', LINEWIDTH, 'FontSize', FONTSIZE);
print(gcf, '-dpng', FIGURE_DPI, filename_figure);
fprintf('\nWrote %s', filename_figure);
...
filename_figure = 'out-EDAQA-3-temperature.png';
set(gca, 'LineWidth', LINEWIDTH, 'FontSize', FONTSIZE);
print(gcf, '-dpng', FIGURE_DPI, filename_figure);
fprintf('\nWrote %s', filename_figure);
...
filename_figure = 'out-EDAQA-4-acceleration.png';
set(gca, 'LineWidth', LINEWIDTH, 'FontSize', FONTSIZE);
print(gcf, '-dpng', FIGURE_DPI, filename_figure);
fprintf('\nWrote %s', filename_figure);
